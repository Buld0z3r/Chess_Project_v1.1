...
ENGINE_PATH = "stockfish-windows-x86-64-avx2.exe"  # Upewnij się, że ścieżka jest poprawna
ANALYSIS_TIME = 0.3
ENGINE_DEPTH = 15
...
def draw_board(board, offset_x=DEFAULT_OFFSET_X, offset_y=DEFAULT_OFFSET_Y, square_size=SQUARE_SIZE, selected_square=None):
